...
# Try Method 1: Basic st_folium
try:
    st.info("🔄 Attempting Method 1: Basic st_folium...")
    st_folium(simple_map, use_container_width=True, height=600)
    st.success("✅ Method 1: Map rendered successfully!")
